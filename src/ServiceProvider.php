...
abstract class ServiceProvider extends BaseServiceProvider
{
    ...
    /** @var string */
    protected $translationsDestinationPath = '{resourcesDestinationPath}/lang/vendor/{namespace}';

    /** @var string */
    protected $translationsPath = '{resourcesPath}/{dirName}';
     ...
     * @param $on
     */
    private function tryRequireHelpers($on)
    {
     ...
     * @param $on
     */
    private function tryRegisterProviders($on)
    {
     ...
     * @return array
     */
    private function getResolvedPaths()
    {
    ...
    private function path($name)
    {
        ...
        $paths[ $name ];
        preg_match_all('/{.*?}/', $paths[ $name ], $matches);
     ...
     * @return array
     */
    private function findCommandsFiles($directory)
    {
        $glob = glob($directory . '/*');
